...
INSERT INTO GRADE (id,grade,nb_voter,seller_id,product_type_id) VALUES (13,108,27,6);
...
INSERT INTO LOCATION (id,city,country,zip,address,lon,lat,user_id) VALUES (2,'Moorsele','United States','740407','Ap #282-3869 Ornare. Road','149.78046','32.22434',30);
...
INSERT INTO LOCATION (id,city,country,zip,address,lon,lat,user_id) VALUES (5,'Camiña','Algeria','01466','Ap #281-5818 Purus St.','46.50841','-17.63177',18);
INSERT INTO LOCATION (id,city,country,zip,address,lon,lat,user_id) VALUES (6,'Traiskirchen','Norfolk Island','800459','Ap #214-1894 Id, Road','6.41102','-77.02139',21);
...
INSERT INTO LOCATION (id,city,country,zip,address,lon,lat,user_id) VALUES (9,'Cowdenbeath','Puerto Rico','8497 EF','9227 Enim Rd.','171.59357','6.22941',24);
...
INSERT INTO LOCATION (id,city,country,zip,address,lon,lat,user_id) VALUES (11,'Hindeloopen','Viet Nam','69867-544','Ap #743-7304 Sed St.','29.57632','14.68857',28);
...
INSERT INTO LOCATION (id,city,country,zip,address,lon,lat,user_id) VALUES (18,'Pontypridd','Samoa','830601','P.O. Box 346, 1294 Montes, Av.','61.59794','66.0858',17);
...
INSERT INTO LOCATION (id,city,country,zip,address,lon,lat,user_id) VALUES (21,'Hannut','Ireland','40614','9634 Lectus Avenue','107.81874','-52.03581',20);


--HOLDING TABLE--
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (1,35510266353376,'Risus Donec Nibh Associates','tristique pellentesque, tellus sem mollis', 1,14,28);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (2,51018813629634,'Rutrum Incorporated','elit, a feugiat tellus lorem eu metus. In lorem.', 1,21,11);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (3,20258648297749,'Eleifend Incorporated','gravida', 1,9,13);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (4,95931812617927,'Amet Consectetuer PC','et, lacinia vitae, sodales at, velit. Pellentesque', 1,16,30);
...
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (6,45314601794816,'Tortor Dictum Institute','sed, sapien. Nunc', 1,17,16);
...
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (9,45579464863985,'Euismod In Dolor LLP','erat nonummy ultricies ornare, elit', 1,20,15);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (10,34561075288802,'Tellus Sem Mollis Associates','placerat, orci lacus vestibulum lorem,', 1,12,18);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (11,78177381535060,'Sit Amet Risus Associates','Curabitur massa. Vestibulum accumsan', 1,19,25);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (12,45759830428287,'Montes Nascetur Ridiculus LLC','Cum sociis natoque penatibus et magnis', 1,10,7);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (13,21951251435093,'Massa LLC','gravida molestie arcu. Sed eu nibh vulputate mauris', 1,9,21);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (14,14194483258761,'Vitae Posuere At LLP','est. Nunc ullamcorper, velit in aliquet lobortis, nisi', 1,14,14);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (15,19790238379500,'Volutpat Nunc Associates','interdum feugiat. Sed nec metus facilisis lorem tristique aliquet. Phasellus', 1,20,18);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (16,32822713665664,'Leo Vivamus Nibh Corporation','senectus et', 1,12,10);
...
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (18,86815033587627,'Commodo Tincidunt Nibh Corp.','elementum at, egestas a, scelerisque', 1,17,22);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (19,62988160378299,'Eros Turpis Non Limited','mollis non, cursus non, egestas a, dui. Cras', 1,11,29);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (20,40570132541470,'Augue Ut Foundation','lobortis risus. In mi pede,', 1,16,16);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (21,15436596567742,'Fringilla Euismod Enim Inc.','fermentum vel, mauris. Integer', 1,10,15);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (22,44629894727841,'Feugiat Placerat Velit Industries','fringilla est. Mauris eu turpis.', 1,12,12);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (23,19996940973214,'Sed Industries','neque', 1,13,8);
INSERT INTO HOLDING (id,siret,name,description,image_id,location_id,owner_id) VALUES (24,75054652085527,'Sed Orci Lobortis Inc.','lectus quis massa. Mauris vestibulum,', 1,17,17);
...
INSERT INTO WAREHOUSE (id,name,description,tel,image_id,location_id) VALUES (7,'Amet Orci Ut Corporation','vel','07 92 16 99 15', 1,22);
...
INSERT INTO WAREHOUSE (id,name,description,tel,image_id,location_id) VALUES (17,'Eu Nulla Industries','Aliquam vulputate ullamcorper magna. Sed eu eros. Nam','07 89 50 45 48', 1,22);
...
--STOCK TABLE--
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (1,'myrtille alsacienne','vulputate mauris sagittis',379,33,38,'18-01-29','18-10-02','false','true', 1,1,29,15,26);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (2,'myrtille alsacienne','vehicula et,',98,58,17,'18-06-03','18-10-15','false','true', 1,2,18,30,4);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (3,'ananas cendré','tortor, dictum eu, placerat eget, venenatis a, magna. Lorem ipsum',17,88,80,'18-04-11','19-03-31','true','true', 1,10,8,9,10);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (4,'pomme de terre asiatique','Etiam gravida molestie arcu. Sed eu nibh vulputate mauris',113,41,67,'18-05-08','19-03-30','false','false', 1,12,17,28,24);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (5,'mangue savoyarde','lobortis augue scelerisque mollis. Phasellus libero',555,59,39,'18-05-12','19-05-12','true','true', 1,9,20,8,7);
...
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (7,'veau marengo','ridiculus mus. Proin vel',287,43,22,'18-03-27','19-07-17','false','false', 1,6,25,19,6);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (8,'veau marengo','massa. Mauris vestibulum, neque sed dictum',320,8,22,'18-04-26','19-02-02','true','false', 1,15,22,8,22);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (9,'papaya de chez stephanie','pretium et, rutrum non, hendrerit id, ante. Nunc mauris sapien,',827,55,77,'18-06-26','19-07-04','true','false', 1,3,12,9,14);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (10,'pomme de terre asiatique','urna. Nullam lobortis quam a felis ullamcorper viverra. Maecenas iaculis',864,6,23,'18-02-04','18-12-07','false','true', 1,3,23,20,12);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (11,'calamar croustillant','dolor sit amet,',483,52,61,'18-05-18','19-02-03','false','true', 1,9,15,14,2);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (12,'ananas cendré','nec ante blandit viverra. Donec tempus,',714,79,61,'18-02-09','19-07-20','true','false', 1,3,16,11,27);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (13,'papaya de chez stephanie','magna. Lorem ipsum dolor sit amet, consectetuer',16,70,67,'18-08-24','19-03-05','true','false', 1,8,18,27,20);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (14,'mangue savoyarde','montes, nascetur',702,52,43,'18-02-18','18-10-04','false','false', 1,8,2,16,11);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (15,'veau marengo','senectus',678,4,43,'18-02-25','18-12-20','false','false', 1,7,19,20,13);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (16,'brocoli du nord','eget,',493,85,32,'18-03-03','18-11-12','true','true', 1,7,3,18,26);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (17,'ananas cendré','ac risus. Morbi metus. Vivamus euismod urna. Nullam lobortis quam',117,1,47,'18-04-25','19-05-20','true','false', 1,11,24,18,10);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (18,'riz pilaf ','eu dui. Cum',9,98,7,'18-02-01','19-05-10','true','true', 1,20,22,21,10);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (19,'poulet bordelais','vulputate, risus a ultricies',684,78,39,'18-10-28','19-05-29','true','true', 1,19,22,24,12);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (20,'calamar croustillant','arcu. Sed et libero. Proin',547,39,64,'18-03-15','19-03-21','true','false', 1,5,12,25,19);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (21,'calamar croustillant','ornare, libero at auctor ullamcorper,',371,30,72,'18-07-16','18-11-08','false','false', 1,19,1,15,10);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (22,'riz pilaf ','magna, malesuada vel, convallis in,',405,97,40,'18-02-01','19-06-19','false','true', 1,11,4,15,25);
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (23,'papaya de chez stephanie','massa. Mauris vestibulum,',140,78,81,'18-05-13','19-05-16','false','false', 1,12,7,13,18);
...
INSERT INTO STOCK (id,name,description,quantity_init,quantity_remaining,price_unit,on_sale_date,expiry_date,bio,available,image_id,product_type_id,holding_id,seller_id,warehouse_id) VALUES (25,'veau marengo','eget magna. Suspendisse',175,18,39,'18-05-02','18-11-19','false','false', 1,10,16,17,17);
