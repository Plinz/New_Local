...
import com.newlocal.domain.Authority;
import com.newlocal.domain.User;
import com.newlocal.repository.AuthorityRepository;
...
import com.newlocal.service.util.RandomUtil;
import com.newlocal.web.rest.errors.*;
...
public class UserService {
    ...
    public User registerUser(UserDTO userDTO, String password) {
        ...
        if (userDTO.getAuthorities() != null && userDTO.getAuthorities().contains("ROLE_SELLER")){
    ...
    @Transactional(readOnly = true)
    public User findByClientIsCurrentUser() {
        return userRepository.findByClientIsCurrentUser();
    }
}
