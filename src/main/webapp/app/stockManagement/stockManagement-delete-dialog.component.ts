...
@Component({
    ...
    templateUrl: './stockManagement-delete-dialog.component.html'
})
export class StockManagementDeleteDialogComponent {
    stock: IStock;
...
export class StockManagementDeletePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ stock }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(StockManagementDeleteDialogComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
